...
# STS-B is regression: only 1 output
...
training_args = TrainingArguments(
    output_dir=f"out_{task_name}_roberta-base",
    ...
    save_total_limit=2,
    num_train_epochs=3,
    per_device_train_batch_size=8,   # consider halving batch-size for base model
...
print(f"✓ Saved fine-tuned RoBERTa-base-{task_name} model to ./{out_dir}")
