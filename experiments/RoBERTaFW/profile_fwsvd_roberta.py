...
from src.utils.SVDBlocks import RobertaFWSVDBlock as FWSVDBlock
...
if __name__ == "__main__":
    ...
    print(f"RoBERTa LowRank FWSVD     | {metric_name}={acc:.4f} | peak ={(peak_lr):6.1f} MiB | real peak ={(peak_lr-with_act + CACHED_ORIG_MEM):6.1f} MiB | Transient={(peak_lr-with_act):6.1f} MiB | {t:6.1f} ms/b")
